...
; Возвращается значение последнего из них - это 27
(define (test5 x)
    ( and 10 20 40 27)
)

; or - выражения вычисляются слева направо, если какое-нибудь выражение дает true, тогда результатом выражения значение, если все значения false, тогда результат всего выражения false
